...
public class GoogleVisionApiClientTest {
	...
	public void deve_realizar_requisicao_para_api_vision() {
		...
		List<ResultadoVisionAPI> resultado = cliente.enviarImagensParaEfetuarOCR(caminhosImagens);
		
		org.junit.Assert.assertFalse(resultado.isEmpty());
		org.junit.Assert.assertTrue(resultado.get(0).getTextoNota().contains("C00:325062"));
